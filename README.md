...
which currently enumerates 1360 direct-PRG object/link shapes.
The non-runtime source-backed matrix contains 192 native ACTC/ALINK/VICE
...
`DO ... UNTIL`/`WHILE ... DO` loops, and plain/guarded nearest-loop `EXIT` in
`tests/parity`.
