...
which currently enumerates 1349 direct-PRG object/link shapes.
The non-runtime source-backed matrix contains 181 native ACTC/ALINK/VICE
...
two-function, declaration-order call-chain, and nested local-call-expression
extensions in `tests/parity`.
