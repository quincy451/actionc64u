...
which currently enumerates 1347 direct-PRG object/link shapes.
The non-runtime source-backed matrix contains 179 native ACTC/ALINK/VICE
...
two-independent-function extension in `tests/parity`.
