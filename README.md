...
which currently enumerates 1352 direct-PRG object/link shapes.
The non-runtime source-backed matrix contains 184 native ACTC/ALINK/VICE
...
frame-preserved forward-call, and bounded function `IF`/`ELSE` extensions in
`tests/parity`.
