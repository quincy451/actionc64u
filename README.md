...
which currently enumerates 1333 direct-PRG object/link shapes.
The non-runtime source-backed matrix contains 172 native ACTC/ALINK/VICE
shapes, including canonical and permuted-storage versions of the shared finite
two-REAL-parameter comparison fixture in `tests/parity`.
