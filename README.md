...
which currently enumerates 1359 direct-PRG object/link shapes.
The non-runtime source-backed matrix contains 191 native ACTC/ALINK/VICE
...
conditional early-return extensions through depth four, and bounded REAL
function `DO ... UNTIL`/`WHILE ... DO` loops in `tests/parity`.
