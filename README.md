...
which currently enumerates 1354 direct-PRG object/link shapes.
The non-runtime source-backed matrix contains 186 native ACTC/ALINK/VICE
...
frame-preserved forward-call, and bounded single, sequential, and nested
function `IF`/`ELSE` extensions in `tests/parity`.
