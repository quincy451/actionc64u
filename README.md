...
which currently enumerates 1377 direct-PRG object/link shapes.
...
The MATH1 runtime matrix additionally launches link-selected `FSign`, `FTrunc`, `FFloor`, `FCeil`, `FRound`, `FFrac`, `FMod`, `FHypot`, `FPow`, `FExp`, `FLn`, `FSin`, `FCos`, `FTan`, `FATan`, `FATan2`, `FASin`,
