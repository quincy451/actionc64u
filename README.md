...
which currently enumerates 1346 direct-PRG object/link shapes.
The non-runtime source-backed matrix contains 178 native ACTC/ALINK/VICE
...
fixture, a nested REAL function-call fixture, and its REAL-local extension in
`tests/parity`.
