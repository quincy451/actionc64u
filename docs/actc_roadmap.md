...
- generalize the proven pass-K function and bounded
  `FSign`/`FTrunc`/`FFloor`/`FCeil`/`FRound`/`FFrac`/`FMod`/`FHypot`/`FPow`/`FExp`/`FLn`/`FLog2`/`FLog10`/`FSin`/`FCos`/`FTan`/`FATan`/`FATan2`/`FMin`/`FMax`/`FClamp` paths into reusable REAL expression,
