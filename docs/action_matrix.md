...
| ACTC object emission | 173 source-backed direct-launch shapes | `make -C ../udos vice-action-actc-alink-launch-object-emission-matrix` |
| ALINK matrix | 1336 direct-PRG object/link shapes | `make -C ../udos vice-action-alink-prg-matrix` |
