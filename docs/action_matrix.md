...
| ACTC object emission | 190 source-backed direct-launch shapes | `make -C ../udos vice-action-actc-alink-launch-object-emission-matrix` |
| ALINK matrix | 1358 direct-PRG object/link shapes | `make -C ../udos vice-action-alink-prg-matrix` |
