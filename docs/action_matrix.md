...
| ACTC object emission | 183 source-backed direct-launch shapes | `make -C ../udos vice-action-actc-alink-launch-object-emission-matrix` |
| ALINK matrix | 1351 direct-PRG object/link shapes | `make -C ../udos vice-action-alink-prg-matrix` |
