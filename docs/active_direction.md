...
Bounded named-REAL `FSign`, `FTrunc`, `FFloor`, `FCeil`, `FRound`, `FFrac`, `FMod`, `FHypot`, `FExp`, `FLn`, `FLog2`, `FLog10`, `FMin`, `FMax`, and `FClamp` calls now have
...
it currently enumerates 1370 shape probes.
