...
Bounded named-REAL `FMin` and `FMax` calls now have complete MATH1 selector
semantics through independently link-selected helpers.
...
it currently enumerates 1329 shape probes.
