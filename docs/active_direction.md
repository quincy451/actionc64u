...
Bounded named-REAL `FSign`, `FTrunc`, `FFloor`, `FCeil`, `FRound`, `FFrac`, `FMod`, `FHypot`, `FExp`, `FLn`, `FMin`, `FMax`, and `FClamp` calls now have
...
it currently enumerates 1368 shape probes.
