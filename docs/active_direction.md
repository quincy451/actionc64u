...
Bounded named-REAL `FSign`, `FTrunc`, `FFloor`, `FCeil`, `FRound`, `FFrac`, `FMod`, `FHypot`, `FExp`, `FMin`, `FMax`, and `FClamp` calls now have
...
it currently enumerates 1367 shape probes.
