...
- The broad direct-PRG matrix currently enumerates 1358 probe shapes from
  `udos/tools/run_action_alink_prg_probe.py`.
- The source-backed sequential, nested, and early-return REAL-function control
  cases prove passes N through P's multiple internal code exports, shared and out-of-order
