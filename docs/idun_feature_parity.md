...
`MAIN`, it now supports up to two independent nonrecursive
...
executes the fixture with identical results. Current inventories are 1,347
broad direct-PRG shapes, 179 non-runtime source-backed object-emission shapes,
and 298 compiled-runtime relocation-oracle cases. Pass L is 5,636 bytes with
