...
integral binary32 values. Pass K also owns a bounded four-REAL root that initializes three
...
cases. Native pass 6 is 8,074 bytes with 118 bytes free under its 96-byte growth
