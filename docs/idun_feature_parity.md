...
products store 4.0 and 7.0, and native VICE prints `47`. Current inventories
are 1,361 broad direct-PRG shapes, 193 non-runtime
...
7,828 bytes with 364 bytes free under its dedicated 256-byte gate. The
