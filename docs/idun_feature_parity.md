...
products print `34`. Current inventories are 1,352 broad direct-PRG shapes, 184 non-runtime
...
1,194 bytes free under its 1 KiB gate. The 28-routine MATH1 gap is unchanged.
