...
class TestRepoLayout(unittest.TestCase):
    ...
    def test_idun_parity_plan_separates_shared_features_from_os_services(self) -> None:
        ...
        self.assertIn("New pass L\nnow consumes that stream", parity)
        ...
        self.assertIn("1,344 broad", parity)
        self.assertIn("176 non-runtime source-backed\nobject-emission shapes", parity)
