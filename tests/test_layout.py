...
class TestRepoLayout(unittest.TestCase):
    ...
    def test_idun_parity_plan_separates_shared_features_from_os_services(self) -> None:
        ...
        self.assertIn("inventories are 1,368 broad direct-PRG", flat_parity)
        self.assertIn("196 non-runtime source-backed object-emission shapes", flat_parity)
        self.assertIn("302 compiled-runtime", flat_parity)
        ...
        self.assertIn("pass-P image is 7,085 bytes with 1,107 bytes free", flat_parity)
        self.assertIn("pass-Q image is 7,089 bytes with 1,103 bytes free", flat_parity)
