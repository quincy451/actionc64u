...
SRC="$SRC_DIR/actc_overlay_preprocess.asm"
CFG="$SRC_DIR/actc_overlay_preprocess.cfg"
OBJ="$BUILD_DIR/actc_overlay_preprocess.o"
BIN="$BUILD_DIR/ACTC_OVLI.BIN"
LABELS="$BUILD_DIR/actc_overlay_preprocess.labels"
MAP="$BUILD_DIR/actc_overlay_preprocess.map"
