...
ca65 -g -D SOURCE_LIMIT=511 -D BODY_OPS_STRIDE=96 -D INT_LITERAL_MAX=32 -D STRING_LITERAL_MAX=32 -D EXPORT_MAX=16 -D EXTERNAL_MAX=16 -D PENDING_SYMBOL_MAX=16 -o "$OBJ" "$SRC" -I "$BUILD_DIR"
